...
public class GetNewSubscriptionSubjectsFragment extends Fragment {
    private Handler mHandler = new Handler();
    public userDataDB upDB;
    public UserProfile up;
    public Parser prs = new Parser();

    public GetNewSubscriptionSubjectsFragment(){}
                    ...
                    webview.setWebViewClient(new WebViewClient() {
                        ...
                        public void onPageFinished(WebView view, String url) {
                            ...
                            if (url.contains("login.asp")) {
                                ...
                                prs.ParseNewSubscriptions(webview, getActivity(), ProfileID, upDB);
