...
public class RefreshProfileFragment extends Fragment {
    private Handler mHandler = new Handler();
    public userDataDB upDB;
    public UserProfile up;
    public Parser prs = new Parser();

    public RefreshProfileFragment(){}
...
//Check username & password
                    ...
                    webview.setWebViewClient(new WebViewClient() {
                        ...
                        public void onPageFinished(WebView view, String url) {
                            super.onPageFinished(view, url);
                            //TODO: Na allakso to loadurl analoga me tin ekdosi px prin apo Jelly bean kai meta i diafora me to window
                            ...
                            if (url.contains("login.asp")) {
                                ...
                                //SERVER OK Parse Profiles


                                prs.ParseProfile(webview, getActivity(), usrname, password, up, upDB);
