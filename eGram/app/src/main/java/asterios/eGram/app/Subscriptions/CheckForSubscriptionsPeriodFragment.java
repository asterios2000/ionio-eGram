...
public class CheckForSubscriptionsPeriodFragment extends Fragment {
    private Handler mHandler = new Handler();
    public userDataDB upDB;
    public UserProfile up;
    public Parser prs = new Parser();

    public CheckForSubscriptionsPeriodFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pd.setMessage(getString(R.string.checkForSubscriptions));
                    ...
                    webview.setWebViewClient(new WebViewClient() {
                        ...
                        public void onPageFinished(WebView view, String url) {
                            ...
                            if (url.contains("login.asp")) {
                                ...
                                //SERVER OK CHECK if it's subscriptions period

                                prs.CheckForSubscriptions(webview,getActivity());
