...
public class RefreshApplicationsFragment extends Fragment {
    ...
    public RefreshApplicationsFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //TODO: Elegxos se periptosi pou einai lathos
                        ...
                        public void onPageFinished(WebView view, String url) {
                            ...
                            if (url.contains("login.asp")) {
                                ...
                                Log.i("det", "Correct Credentials");
                                        ...
                                        //SERVER OK parse APPLICATIONS


                                prs.ParseApplications(webview, getActivity(), ProfileID, upDB);
