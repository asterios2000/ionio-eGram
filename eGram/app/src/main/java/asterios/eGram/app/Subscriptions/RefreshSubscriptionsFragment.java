...
public class RefreshSubscriptionsFragment extends Fragment {
    private Handler mHandler = new Handler();
    public userDataDB upDB;
    public UserProfile up;
    public Parser prs = new Parser();

    public RefreshSubscriptionsFragment(){}
                    ...
                    webview.setWebViewClient(new WebViewClient() {
                        ...
                        public void onPageFinished(WebView view, String url) {
                            ...
                            if (url.contains("login.asp")) {
                                ...
                                //SERVER OK Parse SUBSCRIPTIONS


                                prs.ParseSubscriptions(webview, getActivity(), ProfileID, upDB);
